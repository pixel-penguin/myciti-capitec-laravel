                ...
                <form method="POST" action="{{ route('admin.schedules.store') }}" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="time" name="starts_at" value="{{ old('starts_at') }}" class="border rounded px-3 py-2 w-full" required>
                        </div>
                        <div>
                            <label class="block text-sm text-slate-600 mb-1">Ends at</label>
                            <input type="time" name="ends_at" value="{{ old('ends_at') }}" class="border rounded px-3 py-2 w-full" required>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-3">
                        <button class="px-4 py-2 bg-slate-900 text-white rounded">Create Schedule</button>
